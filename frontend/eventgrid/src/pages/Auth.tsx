  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-orange-200 overflow-hidden flex">
      ...
      <div className="hidden lg:flex w-5/12 bg-stone-900 relative flex-col justify-between p-12 text-white overflow-hidden">
        <div className="z-10">
          <div className="w-10 h-10 bg-white rounded-lg grid grid-cols-2 gap-1 p-1 mb-8">
        ...
        <motion.div 
          ...
          className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-orange-600/30 to-purple-900/30 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2"
        />
        <motion.div 
