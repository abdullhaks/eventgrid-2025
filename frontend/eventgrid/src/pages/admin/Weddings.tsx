// Weddings.tsx (similar, adapted for weddings/marriages)
import { Search, MapPin, MoreVertical } from 'lucide-react';

// Mock data matching ideal MongoDB schema for Weddings services collection
const WEDDINGS_DATA = [
  { _id: 301, name: "Sunset Beach Resort", provider: "Resort Mgmt", price: "$5000/day", rating: 4.9, status: "Booked", location: "Miami, FL" },
  { _id: 302, name: "Mountain View Lodge", provider: "Alpine Corp", price: "$3500/day", rating: 4.8, status: "Active", location: "Aspen, CO" },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Manage Weddings</h2>
          <p className="text-gray-500 text-sm mt-1">Overview of all registered wedding services</p>
        </div>
