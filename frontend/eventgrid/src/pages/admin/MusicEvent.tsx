...
// Mock data matching ideal MongoDB schema for Music services collection
const MUSIC_DATA = [
  { _id: 401, name: "DJ Bass Drop", provider: "Alex Turn", price: "$800/night", rating: 4.5, status: "Active", location: "Los Angeles, CA" },
  { _id: 402, name: "Classical Quartet", provider: "Harmony Group", price: "$1200/event", rating: 4.9, status: "Active", location: "Boston, MA" },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Manage Music Events</h2>
          <p className="text-gray-500 text-sm mt-1">Overview of all registered music services</p>
        </div>
