// Catering.tsx (similar structure, adapted dummy data)
import { Search, MapPin, MoreVertical } from 'lucide-react';

// Mock data matching ideal MongoDB schema for Catering services collection
const CATERING_DATA = [
  { _id: 201, name: "Royal Feast Catering", provider: "Chef Ramsey", price: "$50/plate", rating: 4.7, status: "Active", location: "Chicago, IL" },
  { _id: 202, name: "Green Leaf Vegan", provider: "Lisa Ray", price: "$45/plate", rating: 4.6, status: "Active", location: "Austin, TX" },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Manage Catering</h2>
          <p className="text-gray-500 text-sm mt-1">Overview of all registered catering services</p>
        </div>
